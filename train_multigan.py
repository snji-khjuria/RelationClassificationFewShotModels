...
import sys
from fewshot_re_kit.multiadversarial_framework import FewShotAdversarialREFramework
from models.multigan import MetaDisc, MetaGenerator
import os
import torch
...
disc_model = MetaDisc()
gen_model = MetaGenerator(6980, 60, K)
model = disc_model
gen_model.cuda()
disc_model.cuda()
