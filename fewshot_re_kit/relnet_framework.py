...
class FewShotRelNetREModel(nn.Module):
...
class FewShotRelNetREFramework:
    ...
    def train(self,
        ...
        for it in range(start_iter, start_iter + train_iter):
            ...
            if (it + 1) % val_step == 0:
                ...
                test_acc = self.eval(model, B, N_for_eval, K, Q, val_iter, False)
    ...
    def do_eval(self, model, B, N, K, Q, eval_iter, isVal=True, ckpt=None):
        '''
        model: a FewShotREModel instance
        B: Batch size
        N: Num of classes for each batch
