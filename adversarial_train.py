...
from models.metagan import MetaDisc, MetaGenerator
import os
import torch
...
disc_model = MetaDisc()
gen_model = MetaGenerator(2460, K)
model = disc_model
gen_model.cuda()
disc_model.cuda()
print("Model is ready.")
framework.train(disc_model, gen_model, sentence_encoder, model_name, 8, 20, N, K, 5)
